...
void test_decrypt_block() {
    uchar in[kBlockSize] = { 0xbc, 0x2, 0x8b, 0xd3, 0xe0, 0xe3, 0xb1, 0x95, 0x55, 0xd, 0x6d, 0xf8, 0xe6, 0xf1, 0x82, 0x41 };
    uchar out[kBlockSize];
    uchar key[kBlockSize] = { 0x24, 0x75, 0xA2, 0xB3, 0x34, 0x75, 0x56, 0x88, 0x31, 0xE2, 0x12, 0x00, 0x13, 0xAA, 0x54, 0x87 };
    ...
    uchar true_answer[kBlockSize] = { 0x00, 0x04, 0x12, 0x14, 0x12, 0x04, 0x12, 0x00, 0x0C, 0x00, 0x13, 0x11, 0x08, 0x23, 0x19, 0x19 };
